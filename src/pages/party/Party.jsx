...
function Party() {
    ...
    const handlePageClick = (e) => {
        axiosInstance.get(`/api/vi/party/getAll?page=${e.selected}&size=${size}`)
            .then((res) => {
    ...
    const formSubmit = (e) => {
        e.preventDefault()
        axiosInstance.get(`/api/vi/party/getAll?page=${e.target[0].value - 1}&size=${size}`)
            .then((res) => {
                setData(res.data.content);
            })
    }
    ...
    const changeActive = (id) => {
        axiosInstance.put(`/api/vi/party/active/${id}`)
            .then((res) => {
            ...
            <div className="card">
                <div className="card-header">
                    <div className="d-sm-flex align-items-center justify-content-between">
                        <h2 className="mb-sm-0 font-size-24">Mavjud partiyalar</h2>
